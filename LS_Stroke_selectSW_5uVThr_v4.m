...
%     paramSW.prticle_Thr=80; % percentile of slow waves selected
    ...
    paramSW.fixThr=5; % to select an absolute and not relative threshold
...
writetable(SW_table,[path_save filesep 'SW_5uVThreshold_acrossBlocks_trim.csv'])
